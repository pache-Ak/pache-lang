...
$(BUILD_DIR)/compiler: $(BUILD_DIR)/lexer.o $(BUILD_DIR)/parser.o $(BUILD_DIR)/main.o
		$(CPP) $(CPPFLAGS) $(BUILD_DIR)/lexer.o $(BUILD_DIR)/parser.o $(BUILD_DIR)/main.o -ldl -o $(BUILD_DIR)/compiler
...
$(BUILD_DIR)/main.o: $(SRC_DIR)/main.cpp
		$(CPP) $(CPPFLAGS) $(SRC_DIR)/main.cpp -c -o $(BUILD_DIR)/main.o
